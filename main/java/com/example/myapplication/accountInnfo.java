...
public class accountInnfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "www.msifa.org/acount_info.php", new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                dialog.dismiss();
                Toast.makeText(getApplicationContext(), "jaribu tena baadae", Toast.LENGTH_SHORT).show();
            }
        }) {
