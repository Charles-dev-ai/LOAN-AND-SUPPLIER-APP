...
List<AccountInfoModel> accountInfoModelList;
    ...
    holder.direct_cost.setText("Direct Expenses: "+accountInfoModel.getDirect_cost()+" %");
    ...
    //additional
        holder.actual_debt_large.setText("Actual Debt before penalty: "+accountInfoModel.getActual_debt()+" TZS");
    ...
    public static class Customers extends RecyclerView.ViewHolder{
        ...
        public Customers(@NonNull View itemView) {
            ...
            actual_debt_large=itemView.findViewById(R.id.actualdebt_large);
